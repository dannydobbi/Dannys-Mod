...
public class WorldGenMinableLava extends WorldGenerator
{
    ...
    public WorldGenMinableLava(int par1, int par2)
    {
        this(par1, par2, Block.lavaStill.blockID);
    }
    	
    public WorldGenMinableLava(int par1, int par2, int par3)
    {
    ...
    public WorldGenMinableLava(int id, int meta, int number, int target)
    {
