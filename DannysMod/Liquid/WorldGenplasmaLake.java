...
public class WorldGenplasmaLake extends WorldGenerator implements IWorldGenerator
{
    private int blockIndex;

    public WorldGenplasmaLake(int par1)
    {
    ...
    public void generate(Random random, int chunkX, int chunkZ, World world, IChunkProvider chunkGenerator, IChunkProvider chunkProvider) {
        ...
        if(b.biomeName.equals("extremeHills"));
                ...
                for (i1 = 0; i1 < 16; ++i1)
                {
                    for (j2 = 0; j2 < 16; ++j2)
                    {
                        for (i2 = 0; i2 < 8; ++i2)
                        {
                            ...
                            {
                                par1World.setBlock(par3 + i1, par4 + i2, par5 + j2, Blocks.LiquidplasmaStill.blockID, 0, 2);
                            }
                        }
                    }
                }
            ...
            if (Block.blocksList[this.blockIndex].blockMaterial == Material.water)
            {
                for (i1 = 0; i1 < 16; ++i1)
                {
                    for (j2 = 0; j2 < 16; ++j2)
                    {
                        ...
                        {
                            par1World.setBlock(par3 + i1, par4 + b0, par5 + j2, Blocks.LiquidplasmaStill.blockID, 0, 2);
                        }
                    }
                }
            }
