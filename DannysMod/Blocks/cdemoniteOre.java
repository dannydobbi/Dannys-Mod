...
public class cdemoniteOre extends Block {
private boolean glowing;
public cdemoniteOre(int id) {
super(id, Material.rock);
this.setUnlocalizedName(Names.cdemoniteOre_unlocalizedName);
...
@SideOnly(Side.CLIENT)
	...
	{
	this.blockIcon = i.registerIcon(ModInfo.ID + ":" + "cdemoniteOre");
