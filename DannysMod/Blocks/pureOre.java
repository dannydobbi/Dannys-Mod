...
public class pureOre extends Block {
public pureOre(int id) {
super(id, Material.rock);
this.setUnlocalizedName(Names.pureOre_unlocalizedName);
...
@SideOnly(Side.CLIENT)
	...
	{
	this.blockIcon = i.registerIcon(ModInfo.ID + ":" + "pureOre");
