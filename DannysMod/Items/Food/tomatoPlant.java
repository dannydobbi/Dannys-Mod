...
public class tomatoPlant extends Block implements IPlantable
{
	protected tomatoPlant(int par1, Material par2Material)
	{
	...
	{
		this.blockIcon = i.registerIcon(ModInfo.ID + ":" + "tomatoPlant");
	...
	{
		if(blockID == Blocks.corrupteddemoniteOre.blockID) return Items.Tomato.itemID;
