...
public class ItemdemoniteShovel extends ItemSpade
{
    ...
    public ItemdemoniteShovel(int par1, EnumToolMaterial par2EnumToolMaterial)
    {
    ...
    {
    	if(itemID == Items.demoniteShovel.itemID) this.itemIcon = i.registerIcon(ModInfo.ID + ":" + "demoniteShovel");
    }
}