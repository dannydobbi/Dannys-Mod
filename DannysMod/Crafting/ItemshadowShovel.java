...
public class ItemshadowShovel extends ItemSpade
{
    ...
    public ItemshadowShovel(int par1, EnumToolMaterial par2EnumToolMaterial)
    {
    ...
    {
    	if(itemID == Items.shadowShovel.itemID) this.itemIcon = i.registerIcon(ModInfo.ID + ":" + "shadowShovel");
    }
}