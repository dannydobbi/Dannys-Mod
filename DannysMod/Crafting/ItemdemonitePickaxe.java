...
public class ItemdemonitePickaxe extends ItemPickaxe
{
    ...
    public ItemdemonitePickaxe(int par1, EnumToolMaterial par2EnumToolMaterial)
    {
    ...
    {
	if(itemID == Items.demonitePickaxe.itemID) this.itemIcon = i.registerIcon(ModInfo.ID + ":" + "demonitePickaxe");
    }
}