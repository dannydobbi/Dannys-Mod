...
public class ItemilluminiteShovel extends ItemSpade
{
    ...
    public ItemilluminiteShovel(int par1, EnumToolMaterial par2EnumToolMaterial)
    {
    ...
    {
    	if(itemID == Items.illuminiteShovel.itemID) this.itemIcon = i.registerIcon(ModInfo.ID + ":" + "illuminiteShovel");
    }
}