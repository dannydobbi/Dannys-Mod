...
public class ItemilluminiteHoe extends ItemHoe
{
	  public ItemilluminiteHoe(int par1, EnumToolMaterial par2EnumToolMaterial)
	    {
	    ...
	    {
		if(itemID == Items.illuminiteHoe.itemID) this.itemIcon = i.registerIcon(ModInfo.ID + ":" + "illuminiteHoe");
	    }
}