...
public class ItempureHoe extends ItemHoe
{
	  public ItempureHoe(int par1, EnumToolMaterial par2EnumToolMaterial)
	    {
	    ...
	    {
		if(itemID == Items.pureHoe.itemID) this.itemIcon = i.registerIcon(ModInfo.ID + ":" + "pureHoe");
	    }
}