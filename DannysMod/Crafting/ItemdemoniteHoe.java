...
public class ItemdemoniteHoe extends ItemHoe
{
	  public ItemdemoniteHoe(int par1, EnumToolMaterial par2EnumToolMaterial)
	    {
	    ...
	    {
		if(itemID == Items.demoniteHoe.itemID) this.itemIcon = i.registerIcon(ModInfo.ID + ":" + "demoniteHoe");
	    }
}