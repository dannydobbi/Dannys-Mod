...
public class ItemdemoniteAxe extends ItemAxe
{
    ...
    public ItemdemoniteAxe(int par1, EnumToolMaterial par2EnumToolMaterial)
    {
    ...
    {
	if(itemID == Items.demoniteAxe.itemID) this.itemIcon = i.registerIcon(ModInfo.ID + ":" + "demoniteAxe");
    }
}