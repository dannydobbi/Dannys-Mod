...
public class ItempureAxe extends ItemAxe
{
    ...
    public ItempureAxe(int par1, EnumToolMaterial par2EnumToolMaterial)
    {
    ...
    {
	if(itemID == Items.pureAxe.itemID) this.itemIcon = i.registerIcon(ModInfo.ID + ":" + "pureAxe");
    }
}