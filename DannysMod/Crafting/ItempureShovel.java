...
public class ItempureShovel extends ItemSpade
{
    ...
    public ItempureShovel(int par1, EnumToolMaterial par2EnumToolMaterial)
    {
    ...
    {
    	if(itemID == Items.pureShovel.itemID) this.itemIcon = i.registerIcon(ModInfo.ID + ":" + "pureShovel");
    }
}